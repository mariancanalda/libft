...
/*   Updated: 2023/02/26 21:22:54 by macanald         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// }
		...
		// que el carácter es un carácter ASCII, de lo contrario 
		// e imprime un mensaje que indica que el carácter no es 
		// un carácter ASCII.
		...
		// De lo contrario, si 'ft_isascii()' devuelve un 
		// valor falso, el programa imprime un mensaje 
		// que indica que el carácter no es un carácter 
		// ASCII. 
